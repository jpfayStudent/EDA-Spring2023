...
base_plot <- EPAair %>% 
  ggplot(aes(y=PM2.5,x=as.factor(Year),color=as.factor(Year)))

base_plot + geom_boxplot() + labs(x='Year',color='Year') 

base_plot + geom_violin() + labs(x='Year',color='Year')
...
base_plot + 
  geom_dotplot(binaxis = "y", 
               ...
               stackdir = "center", 
               position = "dodge", 
               dotsize = 0.5) + labs(x='Year',color='Year')
